<div class="groups index">
	<?php /*echo $this->element('backend/search_view',array('currentModel' => 'Group', 'currentField' => 'title'));?>
	<h2><?php __('Groups');?></h2>*/?>
	<div class="add_action_button"><?php echo $this->Html->link(__('Add Group', true), array('action' => 'add')); ?></div>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $group['Group']['weight']; ?>&nbsp;</td>
		<td><?php if($group['Group']['approved'] == 1) echo 'Yes';
		elseif($group['Group']['approved'] == 0) echo 'No';?>&nbsp;</td>
		<td><?php echo $group['Group']['created']; ?>&nbsp;</td>
		<td><?php echo $group['Group']['updated']; ?>&nbsp;</td>
		<td class="actions">
