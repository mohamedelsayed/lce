...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xmlns:fb="https://www.facebook.com/2008/fbml">
	<head>
		...
		//CSS
		echo $this->Html->css(array('old_front/style','old_front/style_slider','old_front/skin', 'old_front/new_style', 'front/jMenu.jquery', 'front/style', 'front/new_style','front/styles_1.css', 'forum/style'));
		//SCRIPTS
