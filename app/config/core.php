...
if (strpos($uri, 'vpc_php_serverhost_do') !== false) {
 ...
 */
	...
	//this is to set time zone to Cairo
	date_default_timezone_set('Africa/Cairo'); //php5.3 is required /* added by Mohamed Elsayed */
/**
 *
